...
const SignUpMiddlewares_1 = __importDefault(require("../middlewares/SignUpMiddlewares"));
...
exports.userRouter.post('/sign-up', ...[upload.none(), ...SignUpValidator_1.default, (0, SignUpMiddlewares_1.default)()], (req, res) => __awaiter(void 0, void 0, void 0, function* () {
